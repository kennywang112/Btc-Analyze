...
exports.MintInteractiveDitemWithRulesCommand = void 0;
...
const get_container_item_1 = require("./get-container-item");
const tinysecp = require('tiny-secp256k1');
(0, bitcoinjs_lib_1.initEccLib)(tinysecp);
const ECPair = (0, ecpair_1.ECPairFactory)(tinysecp);
class MintInteractiveDitemWithRulesCommand {
    constructor(electrumApi, requestDmitem, parentContainer, parentContainerAtomicalId, address, fundingWIF, options) {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const getCmd = new get_container_item_1.GetContainerItemCommand(this.electrumApi, this.parentContainer, this.requestDmitem);
            const getCmdResponse = yield getCmd.run();
            if (getCmdResponse.data.atomical_id) {
                return {
                    success: false,
                    msg: 'Container item is already claimed. Choose another item',
                    data: getCmdResponse.data
                };
            }
            console.log('getCmdResponse', getCmdResponse);
            /*
...
exports.MintInteractiveDitemWithRulesCommand = MintInteractiveDitemWithRulesCommand;
