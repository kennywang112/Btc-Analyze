...
exports.PrepareDmintInteractiveCommand = void 0;
...
class PrepareDmintInteractiveCommand {
    constructor(electrumApi, containerName, mintHeight, immutable, mintbitworkc, owner, funding, options) {
    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            (0, command_helpers_1.logBanner)(`Prepare Container Dmint Config Interactive`);
...
exports.PrepareDmintInteractiveCommand = PrepareDmintInteractiveCommand;
